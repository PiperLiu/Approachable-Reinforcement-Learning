...
class YuanYangEnv:
    ...
    def collide(self, state_position):
        ...
        dy = []
        for i in range(8):
            dx1 = abs(self.obstacle1_x[1] - state_position[0])
            dx.append(dx1)
            dy1 = abs(self.obstacle1_y[1] - state_position[1])
            dy.append(dy1)
        mindx = min(dx)
        mindy = min(dy)
        ...
        dy_second = []
        for i in range(8):
            dx1 = abs(self.obstacle2_x[1] - state_position[0])
            dx_second.append(dx1)
            dy1 = abs(self.obstacle2_y[1] - state_position[1])
