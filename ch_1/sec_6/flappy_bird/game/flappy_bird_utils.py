...
def load():
    ...
    PLAYER_PATH = (
            path + '/assets/sprites/redbird-upflap.png',
            path + '/assets/sprites/redbird-midflap.png',
            path + '/assets/sprites/redbird-downflap.png'
    )

    # path of background
    BACKGROUND_PATH = path + '/assets/sprites/background-black.png'
    ...
    # base (ground) sprite
    IMAGES['base'] = pygame.image.load(path + '/assets/sprites/base.png').convert_alpha()
